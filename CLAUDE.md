...
**Test Vault Location**: `/Volumes/ExtraStrg_RAID1/Mega Sync/Obsidian Plugin Testing/Test Vault/obsidian.main.vault`
...
2. Create symbolic link to test vault (if not already set up):
   ```bash
   ln -s "$(pwd)" "/Volumes/ExtraStrg_RAID1/Mega Sync/Obsidian Plugin Testing/Test Vault/obsidian.main.vault/.obsidian/plugins/smart-links"
   ```
